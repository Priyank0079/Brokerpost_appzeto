...
const Groups = () => {
  ...
  return (
    <div className="-mx-6 lg:-mx-10 -my-6 lg:-my-10 px-6 lg:px-10 py-6 lg:py-10 bg-[#faf9f6] min-h-screen transition-colors duration-300">
      <div className="space-y-6 pb-10">
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <div className="w-20 h-20 bg-[#f1f5f9] rounded-full flex items-center justify-center mb-6">
            <Users size={32} className="text-black opacity-20" />
          </div>
          <h3 className="text-lg font-serif font-bold text-black">No groups assigned</h3>
          <p className="text-[11px] text-slate-400 mt-1 uppercase tracking-widest font-black">Contact admin to be added to a group</p>
        </div>
      </div>
    </div>
  );
