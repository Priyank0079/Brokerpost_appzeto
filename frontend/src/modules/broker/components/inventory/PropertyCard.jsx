...
const PropertyCard = ({ listing }) => {
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-[#c8962a]/20 transition-all duration-300 overflow-hidden flex flex-col group">
      {/* Media / Type Header */}
