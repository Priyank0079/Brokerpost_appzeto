  ...
  return (
    <section className="px-4 pt-6 pb-20 bg-[#F8FAFC]">
      <div className="max-w-[1400px] mx-auto space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-4 md:px-8 md:py-4 bg-white rounded-lg border border-slate-200 shadow-lg shadow-slate-200/20">
        ...
        <div className="rounded-xl bg-white p-4 md:p-5 shadow-[0_10px_40px_rgba(15,23,42,0.05)] border border-slate-100">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <Button
              ...
              className="h-[48px] min-w-[220px] bg-primary-500 hover:bg-primary-600 shadow-none text-white font-semibold"
        ...
        <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl shadow-slate-200/20">
      ...
      >
        {selectedProperty && (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Broker Card */}
            <div className="p-6 bg-slate-900 rounded-xl shadow-xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -mr-16 -mt-16 group-hover:scale-110 transition-transform duration-700" />
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
                <div className="relative">
                  <div className="w-20 h-20 rounded-lg bg-white p-1 overflow-hidden shadow-2xl transform rotate-3">
