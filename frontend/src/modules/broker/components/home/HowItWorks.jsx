...
const steps = [
  {
    id: 1,
    title: "Register Free",
    description: "Create your profile in 2 minutes. No credit card required.",
  ...
  },
  {
    id: 2,
    title: "Post Listings",
    description: "Add inventory OR requirements. Fast & easy posting.",
  ...
  },
  {
    id: 4,
    title: "Collaborate",
    description: "Contact matched brokers and close deals together.",
    ...
    <section className="pt-2 pb-10 px-0 bg-white relative overflow-hidden">
      <div className="w-full px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center space-y-2 mb-8">
          ...
          >
            How <span className="text-primary-600">Brokerspost</span> Works
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Streamlined for Professional Success
          </motion.p>
        </div>
