          ...
          <div className="flex-1 w-full max-w-lg">
            ...
            >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex items-center gap-4 border-t border-slate-100 pt-6">
                    <div className="w-12 h-12 rounded-xl bg-slate-200 overflow-hidden border border-white shadow-sm">
                      <img src={testimonial?.avatar || "https://i.pravatar.cc/150?u=rajesh"} alt={testimonial?.author} className="w-full h-full object-cover" />
                    </div>
                    <div>
                      <h4 className="font-bold text-slate-900 text-base">{testimonial?.author || "Rajesh Sharma"}</h4>
              ...
              <div className="absolute -bottom-4 -right-4 bg-slate-900 text-white px-5 py-3 rounded-2xl shadow-xl border border-white/10 z-20">
                ...
                <div className="text-xl font-black">{testimonial?.successRate || "94.2%"}</div>
              </div>
            </motion.div>
          </div>
